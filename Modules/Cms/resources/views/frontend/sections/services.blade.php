@php
    ...
    $heading = $data['heading'] ?? 'Fitur Utama';
    $subheading = $data['subheading'] ?? 'Kelola siklus hidup aset end-to-end — registrasi, penyusutan, pinjam, movement, tiket & maintenance dalam satu platform.';
@endphp
<section id="produk" class="py-16 md:py-20 bg-surface-container-low">
    <div class="max-w-7xl mx-auto px-6 md:px-8">
        ...
        @if(empty($cards))
            <p class="text-on-surface-variant text-sm">Belum ada fitur — tambah dari CMS (Content → homepage → Produk).</p>
        @else
