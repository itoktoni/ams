            ...
            <x-slot:mobile>
                ...
                <div class="p-3 space-y-3" id="mBody">
                    ...
                    <div class="border border-outline-variant rounded-xl p-4 bg-surface-container-lowest shadow-sm" data-id="{{ $table->field_primary }}">
                        <p class="text-sm font-bold text-on-surface truncate mb-3">{{ $table->kelompok_penyusutan_nama }}</p>
                        <div class="grid grid-cols-2 gap-3 mb-3">
                            <div>
                                <p class="text-[10px] text-on-surface-variant uppercase tracking-wide mb-0.5">Kode</p>
                                <p class="text-xs font-medium text-primary truncate">{{ $table->kelompok_penyusutan_kode ?? '-' }}</p>
                            </div>
                            <div>
                                <p class="text-[10px] text-on-surface-variant uppercase tracking-wide mb-0.5">Metode</p>
                                <p class="text-xs font-medium text-on-surface">{{ $table->kelompok_penyusutan_metode ?? '-' }}</p>
                            </div>
                            <div>
                                <p class="text-[10px] text-on-surface-variant uppercase tracking-wide mb-0.5">Tarif</p>
                                <p class="text-xs font-medium text-on-surface">{{ $table->kelompok_penyusutan_tarif ?? '-' }}</p>
                            </div>
                            <div>
                                <p class="text-[10px] text-on-surface-variant uppercase tracking-wide mb-0.5">Masa Manfaat</p>
                                <p class="text-xs font-medium text-on-surface">{{ $table->kelompok_penyusutan_masa_manfaat ?? '-' }} Tahun</p>
                            </div>
                        </div>
