<?php /** @var App\Models\Peminjaman $table */ ?>
        ...
        <x-table>
            ...
            <x-slot:body>
                ...
                <tr>
                    ...
                    <td class="min-w-[160px]">{{ $table->hasAset?->aset_nama ? $table->hasAset->aset_nama.' — '.$table->hasAset->aset_kode : ($table->peminjaman_id_aset ?? '-') }}</td>
                    @foreach ($model::$sortColumns as $column)
                    <td>
                    ...
                    <div class="bg-white rounded-2xl border border-outline-variant/20 shadow-sm overflow-hidden" data-id="{{ $table->field_primary }}" onclick="mToggle(this)">
                        <div class="p-3.5">
                            ...
                            <div class="mt-3">
                                ...
                                <p class="text-xs text-on-surface-variant mt-1 truncate">{{ $table->hasAset?->aset_nama ? $table->hasAset->aset_nama.' — '.$table->hasAset->aset_kode : ($table->peminjaman_id_aset ?? '') }}</p>
                            </div>
                        ...
                        <div class="flex items-center justify-end px-3.5 py-2.5 bg-surface-container-low/40 border-t border-outline-variant/10" onclick="event.stopPropagation()">
